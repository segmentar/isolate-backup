    ...
    public partial struct MaterialxportablewriteXle_elY
    {
        ...
        public override String ToString()
        {
            return String.Join('\n'.ToString(), new String[] {
                ...
                String.Empty + '\t' + '~' + "04" + ' ' + nameof(Materialxportable) + ':' + ' ' + ". . .",
                String.Empty + '}',
                String.Empty,
                String.Empty + '~' + "10" + ' ' + nameof(Materialxportable) + ':',
                String.Empty + Materialxportable,
    ...
    public partial struct MaterialxportablewriteXlev_lY
    {
        ...
        public override String ToString()
        {
            return String.Join('\n'.ToString(), new String[] {
                ...
                String.Empty + '\t' + '~' + "02" + ' ' + nameof(Length) + ':' + ' ' + Length,
                String.Empty + '\t' + '~' + "03" + ' ' + nameof(Route) + ':' + ' ' + Route,
                String.Empty + '\t' + '~' + "04" + ' ' + nameof(RouteByteArray) + ':' + ' ' + ". . ." + ' ' + $"<{RouteByteArray.Length}>",
                String.Empty + '\t' + '~' + "05" + ' ' + nameof(ObjectByteArray) + ':' + ' ' + ". . ." + ' ' + $"<{ObjectByteArray.Length}>",
                String.Empty + '\t' + '~' + "06" + ' ' + nameof(TypeByteArray) + ':' + ' ' + ". . ." + ' ' + $"<{TypeByteArray.Length}>",
                String.Empty + '\t' + '~' + "07" + ' ' + nameof(Materialxportable) + ':' + ' ' + ". . .",
                String.Empty + '}',
                String.Empty,
                ...
                String.Empty,
                String.Empty + '~' + "40" + ' ' + nameof(Materialxportable) + ':',
                String.Empty + Materialxportable,
            });
        }
    }
    ...
    public partial struct MaterialxportablewriteXleve_Y
    {
        ...
        public override String ToString()
        {
            return String.Join('\n'.ToString(), new String[] {
                ...
                String.Empty + '\t' + '~' + "05" + ' ' + nameof(ObjectByteArray) + ':' + ' ' + ". . ." + ' ' + $"<{ObjectByteArray.Length}>",
                String.Empty + '\t' + '~' + "06" + ' ' + nameof(TypeByteArray) + ':' + ' ' + ". . ." + ' ' + $"<{TypeByteArray.Length}>",
                String.Empty + '\t' + '~' + "07" + ' ' + nameof(RouteStartAddress) + ':' + ' ' + RouteStartAddress,
                String.Empty + '\t' + '~' + "08" + ' ' + nameof(RouteEndAddress) + ':' + ' ' + RouteEndAddress,
                String.Empty + '\t' + '~' + "09" + ' ' + nameof(ObjectStartAddress) + ':' + ' ' + ObjectStartAddress,
                String.Empty + '\t' + '~' + "10" + ' ' + nameof(ObjectEndAddress) + ':' + ' ' + ObjectEndAddress,
                String.Empty + '\t' + '~' + "11" + ' ' + nameof(TypeStartAddress) + ':' + ' ' + TypeStartAddress,
                String.Empty + '\t' + '~' + "12" + ' ' + nameof(TypeEndAddress) + ':' + ' ' + TypeEndAddress,
                String.Empty + '\t' + '~' + "13" + ' ' + nameof(Materialxportable) + ':' + ' ' + ". . .",
                String.Empty + '}',
                String.Empty,
                String.Empty + '~' + "10" + ' ' + nameof(RouteByteArray) + ':',
                String.Empty + String.Join('\n'.ToString(), RouteByteArray),
